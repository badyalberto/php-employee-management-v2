...
INSERT INTO user (username, password) VALUES ("admin", "$2y$10$nuh1LEwFt7Q2/wz9/CmTJO91stTBS4cRjiJYBY3sVCARnllI.wzBC");

INSERT INTO employee (first_name, last_name, age, gender, email, phone_number) VALUES
	("Rack", "Lei", 24, "M", "jackon@network.com", "7383627627"),
	("John", "Doe", 34, "M", "jhondoe@foo.com", "1283645645"),
	("Leila", "Mills", 29, "F", "mills@leila.com", "9983632461"),
	("Richard", "Desmond", 30, "M", "dismond@foo.com", "90876987654"),
	("Susan", "Smith", 28, "F", "susanmith@baz.com", "224355488976"),
	("Brad", "Simpson", 40, "M", "brad@foo.com", "6854634522"),
	("Neil", "Walker", 42, "M", "walkerneil@baz.com", "45372788192"),
	("Robert", "Thomson", 24, "M", "jackon@network.com", "91232876454")
;

INSERT INTO address (employee_id, street, city, postal_code, state) VALUES 
